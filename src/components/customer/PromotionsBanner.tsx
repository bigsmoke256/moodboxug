    ...
    <section className="bg-background px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="relative grid overflow-hidden rounded-[20px] bg-secondary/15 md:grid-cols-2">
          ...
          <svg
            aria-hidden
            className="pointer-events-none absolute -left-8 -bottom-8 h-72 w-72 text-secondary/25"
            viewBox="0 0 200 200"
            fill="none"
          >
            {Array.from({ length: 8 }).map((_, i) => (
              <circle key={i} cx="100" cy="100" r={10 + i * 12} stroke="currentColor" strokeWidth="1" />
            ))}
          </svg>

          <div className="relative z-10 p-8 md:p-12">
            <h2 className="text-h1 text-charcoal">
              Order More, <span className="text-secondary">Save More</span>
            </h2>
            ...
            <a
              href="#menu"
              className="motion-button-elevate mt-6 inline-flex items-center gap-2 rounded-[10px] bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground shadow-soft"
            >
              See Offers
          ...
          <div className="relative min-h-[240px] md:min-h-[280px]">
            ...
            />
            <div className="absolute top-1/2 left-4 -translate-y-1/2 grid h-24 w-24 place-items-center rounded-full bg-primary text-center text-primary-foreground shadow-soft md:h-28 md:w-28">
              <div>
